...
user8.save!
user9 = User.new(username: 'Austin', email: 'austin@gmail.com', password: '123456', type_of_user: 'Assistant', address: 'Framveien 114, Oslo, Norway', phone: '+4741544777')
user9.save!
user10 = User.new(username: 'Simon', email: 'simon@gmail.com', password: '123456', type_of_user: 'Assistant', address: '21 Baker Street, Millbrook, Australia', phone: '+6141544087')
user10.save!
user11 = User.new(username: 'Alex', email: 'alex@gmail.com', password: '123456', type_of_user: 'Assistant', address: 'Lebedeva, bld. 7, Cheboksary, Russia', phone: '+7-41544087')
user11.save!
user12 = User.new(username: 'Yannaty', email: 'yannaty@gmail.com', password: '123456', type_of_user: 'Assistant', address: '1849 St. John Street, Caledon, South Africa', phone: '+2741884087')
user12.save!
user13 = User.new(username: 'Laura', email: 'laura@gmail.com', password: '123456', type_of_user: 'Assistant', address: 'Av. Coronel Bóveda, Quiíndy, Paraguay', phone: '+595276353')
user13.save!
user14 = User.new(username: 'Jimena', email: 'jimena@gmail.com', password: '123456', type_of_user: 'Assistant', address: '2311 5th Avenue, Toronto, Canada', phone: '+1-95276353')
user14.save!
...
user15.save!
user16 = User.new(username: 'McDonalds', email: 'mcdonalds@gmail.com', password: '123456', type_of_user: 'Company', address: '181 Fremont St, San Francisco, United States', phone: '+1-650-543-4800')
user16.save!
...
user17.save!
user18 = User.new(username: 'Google LLC', email: 'google@gmail.com', password: '123456', type_of_user: 'Company', address: '1600 Amphitheatre Parkway Mountain View, CA, United States', phone: '+1 (650) 309-7355')
user18.save!
puts "Created USERS"
...
company4.photo.attach(io: URI.open("https://images.unsplash.com/photo-1619454016518-697bc231e7cb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"), filename: "company4.png", content_type: "image/jpeg")
company4.save!
...
company5.photo.attach(io: URI.open("https://images.unsplash.com/photo-1627843563095-f6e94676cfe0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"), filename: "company5.png", content_type: "image/jpeg")
company5.save!
...
assistant7 = Assistant.new(user_id: user9.id, skills: "Flexibility", availability: 'Part-time', firstname: "Austin", lastname: "Wade")
...
assistant8 = Assistant.new(user_id: user10.id, skills: "Flexibility", availability: 'Full-time', firstname: "Simon", lastname: "Lohmann")
...
assistant9 = Assistant.new(user_id: user11.id, skills: "Flexibility", availability: 'Full-time', firstname: "Alex", lastname: "Supranoff")
...
assistant10 = Assistant.new(user_id: user12.id, skills: "Flexibility", availability: 'Full-time', firstname: "Yannaty", lastname: "Kouth")
...
assistant11 = Assistant.new(user_id: user13.id, skills: "Flexibility", availability: 'Full-time', firstname: "Laura", lastname: "Alonso")
...
assistant12 = Assistant.new(user_id: user14.id, skills: "Flexibility", availability: 'Full-time', firstname: "Jimena", lastname: "Rodriguez")
